...
print "getdata()",len(sns_napi.getdata(handle))
...
print "***** getslab()",len(sns_napi.getslab(handle,(0,0,0),(0,0,167)))
print "***** getslab()",len(sns_napi.getslab(handle,(0,0,0),(0,0,167)))
print "***** getslab()",len(sns_napi.getslab(handle,(1,0,0),(1,0,167)))
